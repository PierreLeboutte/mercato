...
def generate_team(tm):
    ...
    csv_file = r"c:\Users\pierr\PycharmProjects\Mercato\data\teams\{}_players.csv".format(tm)
    ...
    players_df = pd.read_csv(r"c:\Users\pierr\PycharmProjects\Mercato\data\teams\{}_players.csv".format(tm))
    ...
    equipe_type_file = r"C:\Users\pierr\PycharmProjects\Mercato\data\teams\{}_equipe_type.csv".format(tm)
    ...
    stat_file = r"C:\Users\pierr\PycharmProjects\Mercato\data\teams\{}_stats.csv".format(tm)

    with open(stat_file, mode='w', newline='') as file:
        writer = csv.writer(file)
